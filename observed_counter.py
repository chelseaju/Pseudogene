...
Function: Scan through the bam file and count the number of unique reads belong to a given gene region
...
import sys, re, pysam, os, random, argparse, pysam
...
"""
def output_array(array, outfile):
...
def main(parser):
    ...
    ## output data
    outfile = dir + "mapping/" + chromosome_name + "_observed_read_count.txt"
    output_array(counts_array, outfile)
