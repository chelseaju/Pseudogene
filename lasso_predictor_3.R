...
coefficient_file <- paste(dir,"/", type, "_", lasso, "_coefficient_training3.xls", sep="");
...
## write to file
output_v1 <- paste(dir, "/", subdir, "/", type, "_", lasso, "_training_3_prediction_v1.txt", sep="");
output_v2 <- paste(dir, "/", subdir, "/", type, "_", lasso, "_training_3_prediction_v2.txt", sep="");
