...
predicted_file_v1 <- paste(dir,"/", subdir, "/", type, "_", lasso, "_training_3_prediction_v1.txt", sep="");
predicted_file_v2 <- paste(dir,"/", subdir, "/", type, "_", lasso, "_training_3_prediction_v2.txt", sep="");
...
## write to file
output_v1 <- paste(dir, "/", subdir, "/", type, "_", lasso, "_training_3_validation_v1.txt", sep="");
output_v2 <- paste(dir, "/", subdir, "/", type, "_", lasso, "_training_3_validation_v2.txt", sep="");
