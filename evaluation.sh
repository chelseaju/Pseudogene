...
cuffmerge -p 8 -o $CUFFMERGE -g $GTF -s $GENOME $ASSEMBLY --frag-len-mean 300 

## Step 3: Runing cuffdiff
echo ""
echo "Step 3 - Running Cuffdiff"
echo "cuffdiff -p 8 -o $CUFFMERGE -b $GENOME -L $SAMPLEA,$SAMPLEB -u $CUFFMERGE/merged.gtf $DIR/$SAMPLEA/$TOPHAT/$BAM $DIR/$SAMPLEB/$TOPHAT/$BAM"

#cuffdiff -o $CUFFMERGE -b $GENOME -L $SAMPLEA,$SAMPLEB -u $CUFFMERGE/merged.gtf $DIR/$SAMPLEA/$TOPHAT/$BAM $DIR/$SAMPLEB/$TOPHAT/$BAM
