...
python /home/chelseaju/Database/EnsemblTranscriptome/Genes/ENST2ENSG.py -i expected_read_count.txt -o ENSG_expected_read_count.txt -d $DIR/$SUBDIR/$TOPOUT
...
do
  ...
  python /home/chelseaju/Database/EnsemblTranscriptome/Genes/ENSG2PGOHUM.py -d $DIR/$SUBDIR/$TOPOUT/mapping -i ${chr}_genes_distribution.txt -o ${chr}_PGOHUM_distribution.txt
  python /home/chelseaju/Database/EnsemblTranscriptome/Genes/ENST2ENSG.py -d $DIR/$SUBDIR/$TOPOUT/mapping -i ${chr}_PGOHUM_distribution.txt -o ${chr}_ENSG_distribution.txt
